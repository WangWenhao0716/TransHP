...
from losses import DistillationLoss, HiLoss, MaskSoftTargetCrossEntropy, SigSoftTargetCrossEntropy
...
def main(args):
    ...
    if mixup_active:
        ...
        criterion_sig = SigSoftTargetCrossEntropy()
    ...
    '''
    criterion = HiLoss(criterion, criterion_sig)
